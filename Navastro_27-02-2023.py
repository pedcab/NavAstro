...
#Ap1 point 
plt.text(apLong, apLat,"  Ap 1",color='blue')
plt.scatter(apLong, apLat, s=25 ,  facecolors='none', edgecolors='blue' ,linewidth=2 )
#Ap2 point
plt.text(apLong2, apLat,"  Ap 2",color='magenta')
plt.scatter(apLong2, apLat, s=25 ,  facecolors='none', edgecolors='magenta' ,linewidth=2 )
#Ap1 line
m1=math.tan(Zn*DegRad)
b1=apLat-m1*apLong
x_valuesAp1=[((apLat-1)-b1)/m1,((apLat+1)-b1)/m1]
y_valuesAp1=[apLat-1,apLat+1]
plt.plot(x_valuesAp1, y_valuesAp1,linestyle="-",color='blue',linewidth=1)
#Lop1 line
mLop1=-1/m1
#Ap2 line
m2=math.tan(Zn2*DegRad)
b2=apLat-m2*apLong2
x_valuesAp2=[((apLat-1)-b2)/m2,((apLat+1)-b2)/m2]
y_valuesAp2=[apLat-1,apLat+1]
